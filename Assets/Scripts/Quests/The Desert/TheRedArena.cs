...
public class TheRedArena : MonoBehaviour
{
    ...
    public Collider redArenaCollider;
    ...
    private void Awake()
    {
        ...
        if (PlayerPrefs.HasKey("questTheRedArena"))
        {
            AddToJournal.questDone = true;
            redArenaCollider.enabled = false;
    ...
    {
        AddToJournal.questDone = true;
        PlayerPrefs.SetInt("questTheRedArena", 1);
